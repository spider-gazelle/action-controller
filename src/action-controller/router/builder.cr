...
annotation Route::Filter
end

annotation Route::Exception
end
    ...
    {% for route_method in {Route::GET, Route::POST, Route::PUT, Route::PATCH, Route::DELETE, Route::OPTIONS, Route::Filter, Route::Exception} %}
      ...
      {% for method in @type.methods %}
        ...
        {% for ann, idx in method.annotations(route_method) %}
          ...
          {% elsif route_method == Route::Exception %}
          ...
          # Write the method body
            ...
            {% else %}
              args = {
                {% for arg, arg_index in method.args %}
                  {% unless arg_index == 0 && route_method == Route::Exception %}
              ...
              {% if route_method == Route::Exception %}
            ...
            {% if !{Route::Filter}.includes?(route_method) %}
