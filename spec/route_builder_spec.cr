...
describe AC::Route::Builder do
  ...
  it "where no body is expected, accept application/x-www-form-urlencoded data as params", focus: true do
    headers = HTTP::Headers{"Content-Type" => "application/x-www-form-urlencoded"}
    body = "float=3.14"
    result = client.post("/filtering/some_entry/", headers: headers, body: body)
